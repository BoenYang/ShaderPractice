...
public class KCPSocket
{
    ...
    private KCPServer.KCPReceiveListener m_AnyEPListener;
    ...
    public void AddReceiveListener(IPEndPoint remotePoint, KCPServer.KCPReceiveListener listener)
    {
        KCPProxy proxy = GetKcp(remotePoint);
        if (proxy != null)
        {
    ...
    public void RemoveReceiveListener(IPEndPoint remotePoint, KCPServer.KCPReceiveListener listener)
    {
        KCPProxy proxy = GetKcp(remotePoint);
        if (proxy != null)
        {
